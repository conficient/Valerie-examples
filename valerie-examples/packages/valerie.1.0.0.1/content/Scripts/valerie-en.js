...
(function () {
     ...
     * Can be used to compare two dates.
...
(function () {
    ...
    valerie.PropertyValidationState = function (observableOrComputed, options) {
         ...
         * @method
         * @return {boolean} <code>true</code> if the property is required, <code>false</code> otherwise
         */
    ...
    valerie.PropertyValidationState.prototype = {
        ...
        "end": function () {
            var index,
                ...
                valueFormatter = settings.converter.format,
...
(function () {
    ...
    var
        ...
        koSelectedOptionsBindingHandler = ko.bindingHandlers.selectedOptions,
    ...
    valerie.koBindingsHelper = {
        ...
        "useOriginalBindingHandlers": function () {
            ...
            ko.bindingHandlers.selectedOptions = koSelectedOptionsBindingHandler;
        ...
        "useValidatingBindingHandlers": function () {
            ...
            ko.bindingHandlers.selectedOptions = ko.bindingHandlers.validatedSelectedOptions;
...
(function () {
    ...
    rules.Matches = function (permittedValueOrFunction, options) {
        ...
        permittedValueOrFunction = utils.asFunction(permittedValueOrFunction);

        return new rules.OneOf(function() { return [permittedValueOrFunction()]; }, options);
    };
    ...
    rules.NoneOf.prototype = {
        "test": function (value) {
            ...
            for (index = 0; index < values.length; index++) {
                if (utils.areEqual(value, values[index])) {
                    failureMessage = formatting.replacePlaceholders(
                        this.settings.failureMessageFormat, {
                            "value": this.settings.valueFormatter(value, this.settings.valueFormat)
                        });
    ...
    rules.Not = function (forbiddenValueOrFunction, options) {
        ...
        forbiddenValueOrFunction = utils.asFunction(forbiddenValueOrFunction);

        return new rules.NoneOf(function() { return [forbiddenValueOrFunction()]; }, options);
    };
